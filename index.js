...
if (!fs.existsSync(NOTICE_FILE)) fs.writeFileSync(NOTICE_FILE, '{"text":"欢迎加入聊天室！你可以点击右上角的设置按钮自定义你的用户名和头像。<br><h4 class=\"sys_msg\">信息支持html标签哦~</h4>","time":"2025-08-09T07:26:33.991Z"}', 'utf-8')
